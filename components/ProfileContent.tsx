...
export function ProfileContent() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 mt-16">
      ...
      {/* Content Area */}
      <div className="lg:col-span-3 bg-white border border-[#E8E6E1] p-8 md:p-12 min-h-[500px] flex flex-col justify-start">
        <motion.div
          key="education"
          initial={false}
          animate={{
            opacity: activeSection === "education" ? 1 : 0,
            x: activeSection === "education" ? 0 : 20,
          }}
          style={{
