...
export const ResumeSection = ({
  ...
  return (
    <section
      id="profile"
      className={`${hideHeader ? "pb-16 md:pb-32 pt-4" : "py-16 md:py-32"} border-b border-[#E8E6E1] bg-[#FAF9F6] scroll-mt-20`}
    >
        ...
        {!hideHeader && (
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-12 border-b border-[#E8E6E1] mb-16">
            ...
            <p className="text-[#6B6661] text-sm max-w-md font-sans leading-relaxed">
              A comprehensive overview of my experience, projects, skills, and
          ...
          <div className="lg:col-span-4 space-y-10">
            ...
            <div className="bg-white border border-[#E8E6E1] p-8 space-y-6">
              <div>
                ...
                <p className="font-mono text-[11px] text-[#6B6661] mt-1">
                  {profileData.role}
                </p>
              </div>
              ...
              <div className="space-y-3.5 text-xs text-[#6B6661] font-sans">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a
                    ...
                    className="hover:text-[#1C1A17] underline decoration-[#E8E6E1] hover:decoration-[#1C1A17] transition-all"
                  >
                    {profileData.email}
                  </a>
                </div>
                  ...
                  <div key={cat.category} className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {cat.items.map((item) => (
                        <span
                          key={item.name}
                          className="px-2.5 py-1 bg-[#FAF9F6] border border-[#E8E6E1] text-[10px] font-mono text-[#1C1A17]"
                        >
                          {item.name}
                        </span>
                      ))}
                ...
                <div key={idx} className="space-y-4">
                  <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-1">
                    <h4 className="font-serif text-lg font-semibold text-[#1C1A17]">
                      {exp.role}{" "}
                      <span className="font-sans text-xs font-normal text-[#6B6661]">
                        at {exp.company}
                      </span>
                    </h4>
                  ...
                  <ul className="list-none space-y-2 text-xs text-[#6B6661] font-sans leading-relaxed">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <div>
                        <span>
                          Contributing to <strong>Nepdora</strong>, a no-code
                          website builder that allows users to drag and drop UI
                          components to create fully functional websites.
                        </span>
                        <ul className="mt-2 pl-5 space-y-1.5 list-disc list-outside text-[#6B6661]">
                          <li>
                            Built reusable and customizable components using
                            Next.js and TailwindCSS.
                          </li>
                          <li>
                            Implemented dynamic rendering of JSON-based UI
                            configurations for a modular builder experience.
                          </li>
                          <li>
                            Worked on real-time site preview, page management,
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {projects.map((proj) => (
                  <div
                    key={proj.title}
                    className="bg-white border border-[#E8E6E1] p-6 flex flex-col justify-between space-y-4 hover:border-[#1C1A17] transition-all duration-300"
                  >
                    <div className="space-y-2">
                      <div className="flex justify-between items-start gap-2">
                        <h4 className="font-serif text-base font-bold text-[#1C1A17]">
                          {proj.title}
                        </h4>
                    ...
                    <div className="space-y-4 pt-2">
                      <div className="flex flex-wrap gap-1">
                        {proj.technologies.map((tech) => (
                          <span
                            key={tech}
                            className="px-1.5 py-0.5 bg-[#FAF9F6] text-[9px] font-mono text-[#6B6661]"
                          >
                            {tech}
                          </span>
                        ))}
                      ...
                      <div className="flex gap-4 text-xs font-mono pt-2 border-t border-[#E8E6E1]">
                        {proj.githubLink && (
                          <a
                            ...
                            className="flex items-center gap-1 hover:text-[#1C1A17] transition-colors text-[#6B6661]"
                          >
                ...
                <div className="space-y-6">
                  {profileData.education.map((edu, idx) => (
                    <div key={idx} className="space-y-1">
                      <span className="font-mono text-[9px] text-[#6B6661]">
                        {edu.period}
                      </span>
                      <h4 className="font-serif text-sm font-semibold text-[#1C1A17] leading-snug">
                        {edu.degree}
                      </h4>
                      <p className="text-xs text-[#6B6661] font-sans">
                        {edu.institution}
                      </p>
                    </div>
                  ))}
