    ...
    >
      ...
      <div className="lg:col-span-7 space-y-8">
        <div className="inline-flex items-center space-x-2.5 text-xs font-mono tracking-[0.2em] text-[#6B6661]">
          <span className="w-1.5 h-1.5 bg-[#1C1A17] rounded-full inline-block animate-pulse"></span>
          <span>Available for Digital Commissions</span>
        </div>

        <h1 className="font-serif text-4xl sm:text-5xl lg:text-7xl text-[#1C1A17] tracking-normal leading-[1.05] font-medium">
          Designing calm, <br/>
          <span className="italic font-normal text-stone-500 font-serif">considered</span> software.
        </h1>
